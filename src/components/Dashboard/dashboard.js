...
class dashboard extends Component { 
  ...
  componentDidMount() {
      ...
      .then(response => {
          ...
          if(response.data.success == 1){
            if(response.data.data.length > 0){
              this.setState({highestSoldProducts: response.data.data[0].Quantity, highestSoldProductName: response.data.data[0].Product_name});
            }
          }else{
      ...
      .then(response => {
          ...
          if(response.data.success == 1){
            if(response.data.data.length > 0){
              this.setState({lowestSoldProducts: response.data.data[0].Quantity, lowestSoldProductName: response.data.data[0].Product_name});
            }
          }else{
            this.setState({errorMessage: response.data.message });
          }          
      ...
      axios({
        method: 'GET',
        responseType: 'json',
        url: `http://18.216.15.198:3000/api/purchaseorder/getincomingpurchaseorder?companyid=${user.CompanyId}`,
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer '+token
        }          
      ...
      .then(response => {
          ...
          if(response.data.success == 1){
              initialPurchaseOrders = response.data.data.map((order) => {
                  return {id: order.Purchase_OrderId, supplierName: order.Supplier, purchaseDate: order.Date, totalUnits:order.Total_Unit, totalPrice:order.Total} 
              })
              this.setState({
      ...
      axios({
        method: 'GET',
        responseType: 'json',
        url: `http://18.216.15.198:3000/api/sales/getsalespercategory?companyid=${user.CompanyId}`,
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer '+token
        }          
      ...
      axios({
        method: 'GET',
        responseType: 'json',
        url: `http://18.216.15.198:3000/api/product/total_value?companyid=${user.CompanyId}`,
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer '+token
        }         
      ...
      axios({
        method: 'GET',
        responseType: 'json',
        url: `http://18.216.15.198:3000/api/product/total_articles?companyid=${user.CompanyId}`,
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer '+token
        }         
      ...
      axios({
        method: 'GET',
        responseType: 'json',
        url: `http://18.216.15.198:3000/api/sales/getrecentsalesbyweek?CompanyId=${user.CompanyId}`,
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer '+token
        }          
            ...
            <div class="container-fluid  pt-5 mt-3">
              <div class="row">
                ...
                <div class="col-md-12 margin-dashboard px-4"> 
                      ...
                      <div class="col-xl-4 col-sm-6 py-2">
                          <div class="card bg-success text-white h-100">
                              <div class="card-body bg-success">
                                  ...
                                  <h6>{this.state.highestSoldProductName ? this.state.highestSoldProductName  : ''}</h6>
                      ...
                      <div class="col-xl-4 col-sm-6 py-2">
                          <div class="card text-white bg-danger h-100">
                              <div class="card-body bg-danger">
                                  ...
                                  <h6>{this.state.lowestSoldProductName ? this.state.lowestSoldProductName  : ''}</h6>
                    ...
                    <div class="row my-4">
                      <div class="col-lg-8">
                        <div class="table-responsive">
                          <h6 class="text-uppercase  text-center text-primary">Incoming Purchases</h6>
                      ...
                      <div class="col-lg-4">
                      <div class="table-responsive">
                        <h6 class="text-uppercase text-center text-primary">Sales Per Category</h6>
                        <table class="table table-striped table-wrapper-scroll-y my-custom-scrollbar">
                            <thead class="thead-inverse">
                                <tr>
                                  <th>Category Name</th>
                    ...
                    <h2 class="sub-header mt-5  text-center text-primary text-uppercase borderStyle">Inventory Valuation</h2>
                    <div class="mb-3">
                      <div class="card-deck">
                          <div class="card card-inverse card-success text-center">
                              <div class="card-body">
                                  <blockquote class="card-blockquote">
                                      ...
                                      <footer>{this.state.totalOnHand ? this.state.totalOnHand : 0}</footer>
                                  </blockquote>
                              </div>
                          </div>
                          <div class="card card-inverse card-danger text-center">
                              <div class="card-body">
                                  <blockquote class="card-blockquote">
                                      <p class="text-uppercase text-primary">Current Valuation</p>
                                      <footer>{this.state.currentValuation ? this.state.currentValuation : 0}</footer>
                                  </blockquote>
                              </div>
                          </div>                    
                      </div>
                    ...
                    <div class="row my-4">
                      <div class="col-lg-6">
                        <div class="table-responsive">
                          <h6 class="text-uppercase  text-center text-primary">New Sales Orders</h6>
                          <table class="table table-striped table-wrapper-scroll-y my-custom-scrollbar">
                              <thead class="thead-inverse">
                                  <tr>
