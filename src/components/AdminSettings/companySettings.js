...
class companySettings extends Component {
    ...
    componentDidMount() { 
        ...
        axios({
            method: 'GET',
            responseType: 'json',
            url: `http://18.216.15.198:3000/api/companyuser/getCompanyById?CompanyId=${user.CompanyId}`,
            headers: {
    ...
    submitHandler = e => {
        ...
        axios({
            method: 'PUT',
            responseType: 'json',
            url: `http://18.216.15.198:3000/api/companyuser/editCompanyProfile`,data,
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer '+token
            }            
            ...
            <div class="container-fluid  pt-5 mt-3">
                <div class="row">
                    ...
                    <div class="col-md-9 ml-sm-auto col-lg-10 px-4">                    
                        ...
                        <div class="float-left"><h3 class="text-primary">Company Settings</h3></div>                       
                        <form method="post" name="register" onSubmit={this.submitHandler}>
                            ...
                            <div class="row register-form">                                
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" required name="companyEmail" value={this.state.companyEmail} onChange={e => this.ChangeHandler(e)} placeholder="Company Email*" />
                                    </div>
                                </div>                                
                                <div class="col-md-4">                                   
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">                                   
                                    <div class="form-group">
                                        <select name="companyProvince" class="form-control" required
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" required name="companyCity" value={this.state.companyCity} onChange={e => this.ChangeHandler(e)} placeholder="Company City" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text logoStyle" id="inputGroupFileAddon01">Company Logo</span>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <img class="productImage" src={this.state.showcompanyLogo} alt="Company Logo"/>
                                    </div>
                                    <br/>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="companyAddress1" rows="3" value={this.state.companyAddress1} onChange={e => this.ChangeHandler(e)} required>Company Address 1</textarea>
                                    </div>
                                </div> 
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="companyAddress2" rows="3" value={this.state.companyAddress2} onChange={e => this.ChangeHandler(e)} required>Company Address 2</textarea>
                                    </div>
                                </div> 
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" required name="companyPostalCode" value={this.state.companyPostalCode} onChange={e => this.ChangeHandler(e)} placeholder="Company Postal Code" />
                                    </div>
                                </div>
                            </div>
                        </form>
