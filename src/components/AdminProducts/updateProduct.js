    ...
    componentDidMount() { 
        ...
        .then(response => {
            ...
            if(response.data.success == 1){
                ...
                this.setState({
                    suppliersList: [{value: '', display: 'Please select supplier'}].concat(initialSuppliers)
                })
        ...
        .then(response => {
            ...
            if(response.data.success == 1){
                ...
                this.setState({
                    categoriesList: [{value: '', display: 'Please select catgeory'}].concat(initialCategories)
                })
                    ...
                    <div class="col-md-9 ml-sm-auto col-lg-10 px-4">                    
                        ...
                        <form method="post" name="register" onSubmit={this.submitHandler}>
                            ...
                            <div class="row register-form">                                
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="productDesc" rows="3" value={this.state.productDesc} onChange={e => this.ChangeHandler(e)} required >Product Description</textarea>
                                    </div>
                                </div>                                 
                                <div class="col-md-6">                                   
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="productBarcode" value={this.state.productBarcode} onChange={e => this.ChangeHandler(e)} disabled class="form-control"  required placeholder="Bar Code"/>
                                    </div>
                                </div>
                            </div>
                        </form>
