...
class signup extends Component {
  ...
  submitHandler = (e) => {
    ...
    axios({
      method: "POST",
      responseType: "json",
      url: `https://api-tradego.herokuapp.com/api/companyuser/createCompany`,
      data,
    })
      .then((response) => {
        ...
        <div class="row">
          <div class="col-md-3 sidebarborder">
            ...
            <ul class="signupsidebar">
              <li>
                <img
                  className="invenImg float-left "
                  src={inventoryimg1}
                  alt="Inventory Management img1"
                />{" "}
                <p class="signup_p1">
                  {" "}
                  &nbsp;Inventory management system is a tool that allows you to
                  track goods quantity.
                </p>
              </li>
              <li>
                <img
                  className="invenImg"
                  src={inventoryimg2}
                  alt="Inventory Management img2"
                />{" "}
                &nbsp;
                <p class="signup_p2">
                  {" "}
                  &nbsp;Maintain just the right amount of inventory for each
                  product.
                </p>
              </li>
              <li>
                <img
                  className="invenImg"
                  src={inventoryimg3}
                  alt="Inventory Management img3"
                />{" "}
                &nbsp;
                <p class="signup_p3">
                  {" "}
                  &nbsp;Receive alerts and notifications when there’s over- or
                  under-stocking.{" "}
                </p>
              </li>
            </ul>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <input
                        ...
                        title="Postal Code should only contain letters and digits. e.g. G3H6A3"
